...
import { WifiOff, ShieldCheck, BookOpen, Users, Database } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="relative flex flex-col items-center px-6 py-12">
        ...
        <header className="w-full max-w-4xl text-center mb-16 animate-fade-in">
          ...
          <Link href="/signup">
    <button className="mt-8 px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl shadow-lg hover:bg-blue-700 transition">
      Get Started
    </button>
  </Link>
        </header>
